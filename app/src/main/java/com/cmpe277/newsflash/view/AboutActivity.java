...
public class AboutActivity extends AppCompatActivity {
    ...
    private void createLibraryCardViews() {
        ...
        cardViewInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/preeti13parihar"));
    ...
    protected void sendEmail() {
        ...
        emailIntent.setData(Uri.parse("mailto: preet1998parihar@gmail.com"));
