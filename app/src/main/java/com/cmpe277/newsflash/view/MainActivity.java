package com.cmpe277.newsflash.view;
...
import com.cmpe277.newsflash.adapter.DataAdapter;
import com.cmpe277.newsflash.model.ArticleStructure;
import com.cmpe277.newsflash.model.Constants;
import com.cmpe277.newsflash.model.NewsResponse;
import com.cmpe277.newsflash.network.ApiClient;
import com.cmpe277.newsflash.network.ApiInterface;
import com.cmpe277.newsflash.network.interceptors.OfflineResponseCacheInterceptor;
import com.cmpe277.newsflash.network.interceptors.ResponseCacheInterceptor;
import com.cmpe277.newsflash.util.UtilityMethods;
...
//                .withIcon(R.drawable.ic_mail).withTypeface(montserrat_regular);
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch (selected) {
                            ...
                            case 27:
                                ...
                                break;
                            case 28:
                                Intent browserSource = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/preeti13parihar/NewsFlash"));
    ...
    private void loadJSON() {
        ...
        httpClient.cache(new Cache(new File(NewsFlash.getNewsFlashInstance().getCacheDir(), "ResponsesCache"), 10 * 1024 * 1024));
    ...
    **/
    ...
    private void sendEmail() {
        ...
        emailIntent.setData(Uri.parse("mailto: preeti1998parihar@gmail.com"));
